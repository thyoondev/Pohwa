  ...
  return (
    <main>
     ...
     <Stats /> 
      ...
      <div className="h-[100dvh] snap-center overflow-hidden ">
        <Intro />
      </div>
      <div className="h-[100dvh] w-full bg-[url('/bg_1.png')] bg-cover bg-center  snap-center shrink-0">
        <div className="w-full h-full  flex justify-center items-center bg-background/50 p-4 lg:p-14">
          <p className=" text-base lg:text-md font-archivo">
