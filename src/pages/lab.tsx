...
import { Car } from "@/entities/lab/Car";
import { Boxes } from "@/entities/lab/Boxes";
import { FloatingGrid } from "@/entities/lab/FloatingGrid";
import { Ground } from "@/entities/lab/Ground";
import { Rings } from "@/entities/lab/Rings";
...
function App() {
  return (
    <Canvas shadows className="h-full w-full overflow-hidden m-0  snap-start ">
