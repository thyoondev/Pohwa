...
const GlobalFooter = () => {
  return (
    <footer>
      <div className="h-[100dvh] w-full bg-primary p-4 lg:p-14 snap-center shrink-0">
      ...
      <div className="h-[100dvh] w-full bg-background flex justify-start items-center gap-4 px-4 relative snap-center shrink-0">
